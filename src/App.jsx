...
function App() {
  ...
  const initializeSystem = async () => {
    try {
      ...
      // Inicializar sistema básico (categorias, configurações)
      await initializationService.initialize();
      
      // Verificar se precisa de setup inicial (primeira clínica/usuário)
      const needsInitialSetup = await initializationService.needsInitialSetup();
  ...
  // Show setup page if system needs initial setup
  if (needsSetup) {
    return (
      <Router>
        <Routes>
